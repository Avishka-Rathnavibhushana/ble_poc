...
import 'package:ble_poc/widgets.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: GestureDetector(
          ...
          onTap: () async {
            print("object");
            // Stream<List<ScanResult>> list =
            //     await FlutterBlue.instance.scanResults;
            // print("object");
            // int a = await list.length;
            // print("asd" + a.toString());
            print('list of paired devices');
            FlutterBlue.instance.connectedDevices.asStream().listen((paired) {
              print('paired device: $paired');
            });

            var scanSubscription = FlutterBlue.instance
